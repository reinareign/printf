...
/**
 * get_flag - Function that finds the flag function.
 *
 * @s: Format string.
 *
 * @params: Parameter struct.
...
/**
 * get_modifier - This finds the modifier function.
 *
 * @s: Format string.
 *
 * @params: Parameter struct.
 *
 * Return: Returns if modifier's valid.
 */
 ...
 * @params: Parameter struct.
 *
 * @ap: Argument pointer of type var.
 *
